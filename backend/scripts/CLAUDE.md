...
- Run them: python3 -m pytest tests/unit/test\_\*.py -v
...
Live trading: sovereign/orchestrator.py → execute*daily.py
...
Ledger: data/ledger/trade_ledger*\*.jsonl
Logs: logs/
...
_This file is the agent handshake. Both Claude Code and Codex
read it. It removes the human from routine task routing._
_Update CURRENT SYSTEM STATUS at the end of every session._
