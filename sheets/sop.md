...
- add the Reply-To email to the email body
- mention the Reply-To email in the draft
- change the approved response wording
...
Reply-To Email: talent-mgmt@taboost.me / None
...
15A. Scenario A — Initial Inbound Default Response
...
Use Reply-To: talent-mgmt@taboost.me for the following talent inboxes:
...
Gmail: Gmail - KatrinaD
Min Rate: $150 per hour
Auto Send: no
Paused: no
...
Her rate is $150 per hour. Please let us know if you would like to move forward and we can discuss the scope!
...
Talent: Sylvia
Key: Sylvia
Manager: Colin <colin@taboost.me>
Gmail: Gmail - Sylvia
Min Rate: $1000 per video
Auto Send: no
Paused: no
...
Scenario A: Initial Inbound (Default Response)
Approved Response:
Thank you so much for reaching out about a potential partnership with Sylvia!! I am happy to share her rates with you.

Scenario B: Below Minimum Offer
Use when: proposed rate is below Sylvia minimum
Approved Response:
Thank you for reaching out! However her rates are higher than your offer - her minimum rate is $1,000 per video. Please let us know if you would like to move forward at her standard rate!
